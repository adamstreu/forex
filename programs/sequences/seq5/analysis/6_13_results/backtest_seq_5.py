...
'''
Do Note Change Settings.

Backtest settings used to create backtest and create portfolio for 
program running under seq5.

Overview:
    filtered on binom exact the by day.
...
# Run Options
run_program = 0  # remote = 0, local =  1, instance = 2
filter_places = True
filter_binomial = True
...
if __name__ == '__main__': 
    ...
    if run_program == 0:
        ...
        _to =   '2019-01-01T00:00:00Z' 
        outcomes = (0, 0, 0, 1, 0)
        sequence = ((75, 175), (375, 275), (275, 175), (375, 175), (175, 175))
        position = (75, 75)
        direction = 1
        # Indicators
        so_k = 15
