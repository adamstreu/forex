...
#    # Get Differences
#    rolling_pos_diff = get_diff(rolling_pos, windows, instrument_list)
#    rolling_dev_diff = get_diff(rolling_dev, windows, instrument_list)
#    channel_pos_diff = get_diff(channel_pos, windows, instrument_list)
#    channel_dev_diff = get_diff(channel_dev, windows, instrument_list)
...
#    channel_pos.to_csv(path + 'channel_pos.csv', index = False)
#    channel_dev.to_csv(path + 'channel_dev.csv', index = False)
#    rolling_pos_diff.to_csv(path + 'rolling_pos_diff.csv', index = False)
#    rolling_dev_diff.to_csv(path + 'rolling_dev_diff.csv', index = False)
#    channel_pos_diff.to_csv(path + 'channel_pos_diff.csv', index = False)
#    channel_dev_diff.to_csv(path + 'channel_dev_diff.csv', index = False)
